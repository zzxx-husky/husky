...
from bindings.frontend.library.linear_regression import LinearRegressionModel
...
def linear_regresion_hdfs():
    ...
    LR_model.load_hdfs("hdfs:///datasets/regression/MSD/test", is_sparse = 1, format="tsv")
    # Train the model
    LR_model.train(n_iter = 10, alpha = 0.1, is_sparse = 1)

    # Show the parameter
    print "Vector of Parameters:"
    print LR_model.get_param()
    print "intercept term: " + str(LR_model.get_intercept())
